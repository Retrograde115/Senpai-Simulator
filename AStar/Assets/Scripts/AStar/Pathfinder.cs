...
namespace Pathfinding
{
    public class Pathfinder
    {
        ...
        public volatile bool jobDone = false; //Volatile means a field may be modified by multiple threads that are executing at the same time
        ...
        private List<Node> FindPathActual(Node start, Node target)
        {
            ...
            while (openSet.Count > 0)
            {
                ...
                //if we haven't reached our target, then we need to start looking for the neighbours
